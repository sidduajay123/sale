...
<head>
    ...
    <link href="{{ asset( url('vendor/laravel/telescope/public/app.css')) }}" rel="stylesheet" type="text/css">
</head>
<body>
...
<script src="{{asset(url('vendor/laravel/telescope/public/app.js'))}}"></script>
</body>
</html>
