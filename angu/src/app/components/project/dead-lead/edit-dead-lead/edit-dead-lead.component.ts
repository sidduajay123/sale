...
@Component({
  ...
  templateUrl: './edit-dead-lead.component.html',
  styleUrls: ['./edit-dead-lead.component.css']
})
export class EditDeadLeadComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.Jarwis.getdeadupdateuser(this.currentUrl).subscribe(
  ...
  onSubmit(){
    this.Jarwis.updatedeadlead(this.editForm.value).subscribe(
